...
public class Player_Animator_Attack : StateMachineBehaviour {
    ...
    {
        if(GameObject.Find("/Enemy/TinyZombie").GetComponent<TinyZombie_Controller>().GetStatusOfCollider() == true)
        {
            GameObject.Find("/Enemy/TinyZombie").GetComponent<TinyZombie_Controller>().Decreasehealth();
        }
